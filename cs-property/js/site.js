/* =========================================================
   C & S Property Maintenance and Lawn Care — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+19145632712" style="color:var(--color-science-blue);font-weight:600">(914) 563-2712</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "C & S Property Maintenance and Lawn Care",
      phone: "(914) 563-2712",
      phoneTel: "19145632712",
      email: "hello@cspropertymaintenanceandlawncare.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of New Rochelle and nearby towns",
