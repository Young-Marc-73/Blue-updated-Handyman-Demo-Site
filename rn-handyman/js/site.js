...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+19148820125" style="color:var(--color-science-blue);font-weight:600">(914) 882-0125</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "R-N-Handyman",
      phone: "(914) 882-0125",
      phoneTel: "19148820125",
      email: "hello@rnhandyman.com",
