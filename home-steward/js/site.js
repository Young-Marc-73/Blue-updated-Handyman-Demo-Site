/* =========================================================
   Handy Home Steward — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+14012579991" style="color:var(--color-science-blue);font-weight:600">(401) 257-9991</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Handy Home Steward",
      phone: "(401) 257-9991",
      phoneTel: "14012579991",
      email: "hello@handyhomesteward.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of Middletown and nearby towns",
