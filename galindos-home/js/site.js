/* =========================================================
   Galindo's Home Improvement — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+16313795819" style="color:var(--color-science-blue);font-weight:600">(631) 379-5819</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Galindo's Home Improvement",
      phone: "(631) 379-5819",
      phoneTel: "16313795819",
      email: "hello@galindoshomeimprovement.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of Huntington and nearby towns",
