/* =========================================================
   Handyman Solutions — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+19142352499" style="color:var(--color-science-blue);font-weight:600">(914) 235-2499</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      ...
      phone: "(914) 235-2499",
      phoneTel: "19142352499",
      email: "hello@handymansolutions.com",
