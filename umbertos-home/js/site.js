/* =========================================================
   Umberto's Home Improvements — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12018574947" style="color:var(--color-science-blue);font-weight:600">(201) 857-4947</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Umberto's Home Improvements",
      phone: "(201) 857-4947",
      phoneTel: "12018574947",
      email: "hello@umbertoshomeimprovements.com",
