/* =========================================================
   Forest Hill Handyman Services — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+15517952018" style="color:var(--color-science-blue);font-weight:600">(551) 795-2018</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Forest Hill Handyman Services",
      phone: "(551) 795-2018",
      phoneTel: "15517952018",
      email: "hello@foresthillhandymanservices.com",
