/* =========================================================
   G.O Home Improvement — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+19148373687" style="color:var(--color-science-blue);font-weight:600">(914) 837-3687</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "G.O Home Improvement",
      phone: "(914) 837-3687",
      phoneTel: "19148373687",
      email: "hello@gohomeimprovement.com",
