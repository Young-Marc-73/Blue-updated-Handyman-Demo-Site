/* =========================================================
   Berry's Home Improvements — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+18628998337" style="color:var(--color-science-blue);font-weight:600">(862) 899-8337</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Berry's Home Improvements",
      phone: "(862) 899-8337",
      phoneTel: "18628998337",
      email: "hello@berryshomeimprovements.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of Saddle Brook and nearby towns",
