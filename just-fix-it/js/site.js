...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12037906823" style="color:var(--color-science-blue);font-weight:600">(203) 790-6823</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Just Fix It",
      phone: "(203) 790-6823",
      phoneTel: "12037906823",
      email: "hello@justfixit.com",
