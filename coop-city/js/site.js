/* =========================================================
   Co-op City Handyman — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+19174568220" style="color:var(--color-science-blue);font-weight:600">(917) 456-8220</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Co-op City Handyman",
      phone: "(917) 456-8220",
      phoneTel: "19174568220",
      email: "hello@coopcityhandyman.com",
