/* =========================================================
   Fix It Handyman Services — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+15162206376" style="color:var(--color-science-blue);font-weight:600">(516) 220-6376</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      ...
      phone: "(516) 220-6376",
      phoneTel: "15162206376",
      email: "hello@fixithandymanservices.com",
