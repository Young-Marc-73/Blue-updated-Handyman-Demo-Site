/* =========================================================
   Z & L Handyman Construction — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+16172370166" style="color:var(--color-science-blue);font-weight:600">(617) 237-0166</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Z & L Handyman Construction",
      phone: "(617) 237-0166",
      phoneTel: "16172370166",
      email: "hello@zlhandymanconstruction.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of Quincy and nearby towns",
