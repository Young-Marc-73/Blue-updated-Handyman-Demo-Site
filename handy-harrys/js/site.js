...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+15168623224" style="color:var(--color-science-blue);font-weight:600">(516) 862-3224</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Handy Harry's",
      phone: "(516) 862-3224",
      phoneTel: "15168623224",
      email: "hello@handyharrys.com",
