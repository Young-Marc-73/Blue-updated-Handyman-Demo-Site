/* =========================================================
   Sortos Handyman Electric — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12677211155" style="color:var(--color-science-blue);font-weight:600">(267) 721-1155</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Sortos Handyman Electric",
      phone: "(267) 721-1155",
      phoneTel: "12677211155",
      email: "hello@sortoshandymanelectric.com",
