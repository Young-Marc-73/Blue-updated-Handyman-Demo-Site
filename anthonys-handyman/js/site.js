/* =========================================================
   Anthony's Handyman Services — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+13476410619" style="color:var(--color-science-blue);font-weight:600">(347) 641-0619</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Anthony's Handyman Services",
      phone: "(347) 641-0619",
      phoneTel: "13476410619",
      email: "hello@anthonyshandymanservices.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of Bronx and nearby towns",
