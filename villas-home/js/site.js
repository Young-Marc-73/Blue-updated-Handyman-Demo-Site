/* =========================================================
   Villa's Home Improvement — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12038333429" style="color:var(--color-science-blue);font-weight:600">(203) 833-3429</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Villa's Home Improvement",
      phone: "(203) 833-3429",
      phoneTel: "12038333429",
      email: "hello@villashomeimprovement.com",
