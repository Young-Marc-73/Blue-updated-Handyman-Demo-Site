    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+14012521514" style="color:var(--color-science-blue);font-weight:600">(401) 252-1514</a></p>' +
          '</div>';
      });
    });
  }
