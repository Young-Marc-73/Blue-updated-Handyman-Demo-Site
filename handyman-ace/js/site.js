...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+19142914816" style="color:var(--color-science-blue);font-weight:600">(914) 291-4816</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Handyman Ace",
      phone: "(914) 291-4816",
      phoneTel: "19142914816",
      email: "hello@handymanace.com",
