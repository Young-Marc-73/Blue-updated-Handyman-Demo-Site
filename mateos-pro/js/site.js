/* =========================================================
   Mateos Pro Handyman Services — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+17743036479" style="color:var(--color-science-blue);font-weight:600">(774) 303-6479</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Mateos Pro Handyman Services",
      phone: "(774) 303-6479",
      phoneTel: "17743036479",
      email: "hello@mateosprohandymanservices.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of Worcester and nearby towns",
