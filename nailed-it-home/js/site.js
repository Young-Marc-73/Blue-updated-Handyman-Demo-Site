/* =========================================================
   Nailed It Home Repair — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+17742610709" style="color:var(--color-science-blue);font-weight:600">(774) 261-0709</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Nailed It Home Repair",
      phone: "(774) 261-0709",
      phoneTel: "17742610709",
      email: "hello@nailedithomerepair.com",
