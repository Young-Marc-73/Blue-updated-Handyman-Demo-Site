/* =========================================================
   JC Quality Home Improvement — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+19145647006" style="color:var(--color-science-blue);font-weight:600">(914) 564-7006</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "JC Quality Home Improvement",
      phone: "(914) 564-7006",
      phoneTel: "19145647006",
      email: "hello@jcqualityhomeimprovement.com",
