...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+14018495656" style="color:var(--color-science-blue);font-weight:600">(401) 849-5656</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      ...
      phone: "(401) 849-5656",
      phoneTel: "14018495656",
      email: "hello@coastalelectric.com",
