/* =========================================================
   21st Century Home Repair & Improvement — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12157187840" style="color:var(--color-science-blue);font-weight:600">(215) 718-7840</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "21st Century Home Repair & Improvement",
      phone: "(215) 718-7840",
      phoneTel: "12157187840",
      email: "hello@21stcenturyhomerepairimprovement.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of Lansdale and nearby towns",
