/* =========================================================
   Ozzie Handyman and Remodeling — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+19084608905" style="color:var(--color-science-blue);font-weight:600">(908) 460-8905</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Ozzie Handyman and Remodeling",
      phone: "(908) 460-8905",
      phoneTel: "19084608905",
      email: "hello@ozziehandymanandremodeling.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of Madison and nearby towns",
