/* =========================================================
   Gabriel & Sons Services — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12032923687" style="color:var(--color-science-blue);font-weight:600">(203) 292-3687</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Gabriel & Sons Services",
      phone: "(203) 292-3687",
      phoneTel: "12032923687",
      email: "hello@gabrielsonsservices.com",
