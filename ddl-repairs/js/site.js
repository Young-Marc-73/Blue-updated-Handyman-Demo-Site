...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+16315229738" style="color:var(--color-science-blue);font-weight:600">(631) 522-9738</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "DDL Home Repairs",
      phone: "(631) 522-9738",
      phoneTel: "16315229738",
      email: "hello@ddlhomerepairs.com",
