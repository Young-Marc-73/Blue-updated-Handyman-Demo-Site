/* =========================================================
   Just Ask Airamis Handyman — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+19296209165" style="color:var(--color-science-blue);font-weight:600">(929) 620-9165</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Just Ask Airamis Handyman",
      phone: "(929) 620-9165",
      phoneTel: "19296209165",
      email: "hello@justaskairamishandyman.com",
