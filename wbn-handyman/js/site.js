/* =========================================================
   W. B. N. Handyman Care — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+16172846790" style="color:var(--color-science-blue);font-weight:600">(617) 284-6790</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "W. B. N. Handyman Care",
      phone: "(617) 284-6790",
      phoneTel: "16172846790",
      email: "hello@wbnhandymancare.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of Waban and nearby towns",
