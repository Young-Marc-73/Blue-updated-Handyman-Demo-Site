/* =========================================================
   Cali Home Improvement — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12039527080" style="color:var(--color-science-blue);font-weight:600">(203) 952-7080</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Cali Home Improvement",
      phone: "(203) 952-7080",
      phoneTel: "12039527080",
      email: "hello@calihomeimprovement.com",
