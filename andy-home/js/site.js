/* =========================================================
   Andy Home Improvement — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+15084685491" style="color:var(--color-science-blue);font-weight:600">(508) 468-5491</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Andy Home Improvement",
      phone: "(508) 468-5491",
      phoneTel: "15084685491",
      email: "hello@andyhomeimprovement.com",
