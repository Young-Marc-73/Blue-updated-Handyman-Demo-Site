/* =========================================================
   All-Around Handy Man — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+14017716593" style="color:var(--color-science-blue);font-weight:600">(401) 771-6593</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "All-Around Handy Man",
      phone: "(401) 771-6593",
      phoneTel: "14017716593",
      email: "hello@allaroundhandyman.com",
