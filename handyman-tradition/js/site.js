/* =========================================================
   Handyman Tradition — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+19737077900" style="color:var(--color-science-blue);font-weight:600">(973) 707-7900</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Handyman Tradition",
      phone: "(973) 707-7900",
      phoneTel: "19737077900",
      email: "hello@handymantradition.com",
