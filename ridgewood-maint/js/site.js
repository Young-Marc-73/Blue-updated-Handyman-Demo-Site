/* =========================================================
   Ridgewood Home Maintenance — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12016129320" style="color:var(--color-science-blue);font-weight:600">(201) 612-9320</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Ridgewood Home Maintenance",
      phone: "(201) 612-9320",
      phoneTel: "12016129320",
      email: "hello@ridgewoodhomemaintenance.com",
