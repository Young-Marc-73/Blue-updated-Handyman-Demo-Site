/* =========================================================
   Jay's Home Improvement — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12036671300" style="color:var(--color-science-blue);font-weight:600">(203) 667-1300</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Jay's Home Improvement",
      phone: "(203) 667-1300",
      phoneTel: "12036671300",
      email: "hello@jayshomeimprovement.com",
