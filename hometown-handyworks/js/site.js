/* =========================================================
   Hometown Handyworks — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+16313758847" style="color:var(--color-science-blue);font-weight:600">(631) 375-8847</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Hometown Handyworks",
      phone: "(631) 375-8847",
      phoneTel: "16313758847",
      email: "hello@hometownhandyworks.com",
