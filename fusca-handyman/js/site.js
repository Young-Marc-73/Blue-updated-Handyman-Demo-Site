...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+14012075222" style="color:var(--color-science-blue);font-weight:600">(401) 207-5222</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Fusca Handyman",
      phone: "(401) 207-5222",
      phoneTel: "14012075222",
      email: "hello@fuscahandyman.com",
