/* =========================================================
   QJK Newtonville Handyman & Remodeling — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+16176827821" style="color:var(--color-science-blue);font-weight:600">(617) 682-7821</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "QJK Newtonville Handyman & Remodeling",
      phone: "(617) 682-7821",
      phoneTel: "16176827821",
      email: "hello@qjknewtonvillehandymanremodeling.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of Newtonville and nearby towns",
