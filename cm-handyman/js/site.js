/* =========================================================
   C M Handyman Solutions — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+16177954004" style="color:var(--color-science-blue);font-weight:600">(617) 795-4004</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "C M Handyman Solutions",
      phone: "(617) 795-4004",
      phoneTel: "16177954004",
      email: "hello@cmhandymansolutions.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of Chestnut Hill and nearby towns",
