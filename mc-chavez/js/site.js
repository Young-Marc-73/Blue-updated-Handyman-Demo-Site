/* =========================================================
   MC Chavez Painting — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+19142820354" style="color:var(--color-science-blue);font-weight:600">(914) 282-0354</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "MC Chavez Painting",
      phone: "(914) 282-0354",
      phoneTel: "19142820354",
      email: "hello@mcchavezpainting.com",
