/* =========================================================
   Aquidneck Handyman — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+14013071870" style="color:var(--color-science-blue);font-weight:600">(401) 307-1870</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Aquidneck Handyman",
      phone: "(401) 307-1870",
      phoneTel: "14013071870",
      email: "hello@aquidneckhandyman.com",
