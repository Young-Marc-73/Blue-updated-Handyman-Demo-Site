/* =========================================================
   JM Handyman & Contracting — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+19145636451" style="color:var(--color-science-blue);font-weight:600">(914) 563-6451</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "JM Handyman & Contracting",
      phone: "(914) 563-6451",
      phoneTel: "19145636451",
      email: "hello@jmhandymancontracting.com",
