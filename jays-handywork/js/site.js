...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12035830356" style="color:var(--color-science-blue);font-weight:600">(203) 583-0356</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Jay's Handywork",
      phone: "(203) 583-0356",
      phoneTel: "12035830356",
      email: "hello@jayshandywork.com",
