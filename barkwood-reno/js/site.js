/* =========================================================
   Barkwood Renovations & Handyman — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+14753395279" style="color:var(--color-science-blue);font-weight:600">(475) 339-5279</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Barkwood Renovations & Handyman",
      phone: "(475) 339-5279",
      phoneTel: "14753395279",
      email: "hello@barkwoodrenovationshandyman.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of Brookfield and nearby towns",
