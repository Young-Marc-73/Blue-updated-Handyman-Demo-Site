/* =========================================================
   Bergen Home Services — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12016123434" style="color:var(--color-science-blue);font-weight:600">(201) 612-3434</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Bergen Home Services",
      phone: "(201) 612-3434",
      phoneTel: "12016123434",
      email: "hello@bergenhomeservices.com",
