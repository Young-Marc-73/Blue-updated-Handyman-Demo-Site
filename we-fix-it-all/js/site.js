/* =========================================================
   We Fix It All Handyman Work Services — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12014975857" style="color:var(--color-science-blue);font-weight:600">(201) 497-5857</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "We Fix It All Handyman Work Services",
      phone: "(201) 497-5857",
      phoneTel: "12014975857",
      email: "hello@wefixitallhandymanworkservices.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of Ridgewood and nearby towns",
