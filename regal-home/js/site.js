/* =========================================================
   Regal Home Improvements — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+19733809707" style="color:var(--color-science-blue);font-weight:600">(973) 380-9707</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Regal Home Improvements",
      phone: "(973) 380-9707",
      phoneTel: "19733809707",
      email: "hello@regalhomeimprovements.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of Bloomfield and nearby towns",
