...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+16175832020" style="color:var(--color-science-blue);font-weight:600">(617) 583-2020</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Coops Handyman",
      phone: "(617) 583-2020",
      phoneTel: "16175832020",
      email: "hello@coopshandyman.com",
