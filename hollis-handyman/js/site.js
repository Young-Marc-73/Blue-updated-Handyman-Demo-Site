/* =========================================================
   Hollis Handyman Services — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+15084364672" style="color:var(--color-science-blue);font-weight:600">(508) 436-4672</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Hollis Handyman Services",
      phone: "(508) 436-4672",
      phoneTel: "15084364672",
      email: "hello@hollishandymanservices.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of Framingham and nearby towns",
