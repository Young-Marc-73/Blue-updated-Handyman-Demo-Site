/* =========================================================
   Kyle Can Home Services — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12673785198" style="color:var(--color-science-blue);font-weight:600">(267) 378-5198</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Kyle Can Home Services",
      phone: "(267) 378-5198",
      phoneTel: "12673785198",
      email: "hello@kylecanhomeservices.com",
