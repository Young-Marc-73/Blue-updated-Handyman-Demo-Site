/* =========================================================
   CharBella Contracting — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+18622122520" style="color:var(--color-science-blue);font-weight:600">(862) 212-2520</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "CharBella Contracting",
      phone: "(862) 212-2520",
      phoneTel: "18622122520",
      email: "hello@charbellacontracting.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of East Hanover and nearby towns",
