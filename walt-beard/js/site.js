/* =========================================================
   Walt Beard Repairs & Home Improvements — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12672182419" style="color:var(--color-science-blue);font-weight:600">(267) 218-2419</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Walt Beard Repairs & Home Improvements",
      phone: "(267) 218-2419",
      phoneTel: "12672182419",
      email: "hello@waltbeardrepairshomeimprovements.com",
