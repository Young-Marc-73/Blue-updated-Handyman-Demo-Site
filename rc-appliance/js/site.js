/* =========================================================
   R&C Appliance Doctor — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12014016666" style="color:var(--color-science-blue);font-weight:600">(201) 401-6666</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "R&C Appliance Doctor",
      phone: "(201) 401-6666",
      phoneTel: "12014016666",
      email: "hello@rcappliancedoctor.com",
