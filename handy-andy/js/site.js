...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+16466009684" style="color:var(--color-science-blue);font-weight:600">(646) 600-9684</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Handy Andy",
      phone: "(646) 600-9684",
      phoneTel: "16466009684",
      email: "hello@handyandy.com",
