/* =========================================================
   Piece by Piece Home Services — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12034247790" style="color:var(--color-science-blue);font-weight:600">(203) 424-7790</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Piece by Piece Home Services",
      phone: "(203) 424-7790",
      phoneTel: "12034247790",
      email: "hello@piecebypiecehomeservices.com",
