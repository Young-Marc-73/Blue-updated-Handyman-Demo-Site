/* =========================================================
   Dean's Handyman Services — Site script
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+18574527503" style="color:var(--color-science-blue);font-weight:600">(857) 452-7503</a></p>' +
          '</div>';
      });
    });
  }
