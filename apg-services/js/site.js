...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+16175929644" style="color:var(--color-science-blue);font-weight:600">(617) 592-9644</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "A.P.G. Services",
      phone: "(617) 592-9644",
      phoneTel: "16175929644",
      email: "hello@apgservices.com",
