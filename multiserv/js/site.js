...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+14016781501" style="color:var(--color-science-blue);font-weight:600">(401) 678-1501</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Multiserv",
      phone: "(401) 678-1501",
      phoneTel: "14016781501",
      email: "hello@multiserv.com",
