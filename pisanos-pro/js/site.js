/* =========================================================
   Pisano's Pro Property Services — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+17742127326" style="color:var(--color-science-blue);font-weight:600">(774) 212-7326</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Pisano's Pro Property Services",
      phone: "(774) 212-7326",
      phoneTel: "17742127326",
      email: "hello@pisanospropropertyservices.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of West Yarmouth and nearby towns",
