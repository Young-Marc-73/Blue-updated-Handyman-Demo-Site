/* =========================================================
   Hazlets Handyman & Remodeling — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+18487578964" style="color:var(--color-science-blue);font-weight:600">(848) 757-8964</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Hazlets Handyman & Remodeling",
      phone: "(848) 757-8964",
      phoneTel: "18487578964",
      email: "hello@hazletshandymanremodeling.com",
