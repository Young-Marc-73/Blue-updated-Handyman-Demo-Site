/* =========================================================
   Flawless Home Repair — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+16315219520" style="color:var(--color-science-blue);font-weight:600">(631) 521-9520</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Flawless Home Repair",
      phone: "(631) 521-9520",
      phoneTel: "16315219520",
      email: "hello@flawlesshomerepair.com",
