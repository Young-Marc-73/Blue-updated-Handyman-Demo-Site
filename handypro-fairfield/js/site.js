/* =========================================================
   HandyPro of Fairfield County — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12034290050" style="color:var(--color-science-blue);font-weight:600">(203) 429-0050</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "HandyPro of Fairfield County",
      phone: "(203) 429-0050",
      phoneTel: "12034290050",
      email: "hello@handyprooffairfieldcounty.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of Westport and nearby towns",
