/* =========================================================
   Charles Home Improvement — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+14752909905" style="color:var(--color-science-blue);font-weight:600">(475) 290-9905</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Charles Home Improvement",
      phone: "(475) 290-9905",
      phoneTel: "14752909905",
      email: "hello@charleshomeimprovement.com",
