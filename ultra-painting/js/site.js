/* =========================================================
   Ultra Painting & Home Improvement — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+19736828543" style="color:var(--color-science-blue);font-weight:600">(973) 682-8543</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Ultra Painting & Home Improvement",
      phone: "(973) 682-8543",
      phoneTel: "19736828543",
      email: "hello@ultrapaintinghomeimprovement.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of Morristown and nearby towns",
