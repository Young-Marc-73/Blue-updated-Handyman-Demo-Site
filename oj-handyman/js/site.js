/* =========================================================
   OJ Handyman Services — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+16316808180" style="color:var(--color-science-blue);font-weight:600">(631) 680-8180</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "OJ Handyman Services",
      phone: "(631) 680-8180",
      phoneTel: "16316808180",
      email: "hello@ojhandymanservices.com",
