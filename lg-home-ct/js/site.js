/* =========================================================
   LG Home Improvement — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12032232712" style="color:var(--color-science-blue);font-weight:600">(203) 223-2712</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "LG Home Improvement",
      phone: "(203) 223-2712",
      phoneTel: "12032232712",
      email: "hello@lghomeimprovement.com",
