/* =========================================================
   Sam's Handyman Service — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+17742416151" style="color:var(--color-science-blue);font-weight:600">(774) 241-6151</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Sam's Handyman Service",
      phone: "(774) 241-6151",
      phoneTel: "17742416151",
      email: "hello@samshandymanservice.com",
