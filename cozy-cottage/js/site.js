/* =========================================================
   Cozy Cottage Craftsman Services — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12155001387" style="color:var(--color-science-blue);font-weight:600">(215) 500-1387</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Cozy Cottage Craftsman Services",
      phone: "(215) 500-1387",
      phoneTel: "12155001387",
      email: "hello@cozycottagecraftsmanservices.com",
