...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+19737807103" style="color:var(--color-science-blue);font-weight:600">(973) 780-7103</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "R&M Handyman Corp.",
      phone: "(973) 780-7103",
      phoneTel: "19737807103",
      email: "hello@rmhandymancorp.com",
