/* =========================================================
   Redding BMC Handyman Services — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12034173023" style="color:var(--color-science-blue);font-weight:600">(203) 417-3023</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Redding BMC Handyman Services",
      phone: "(203) 417-3023",
      phoneTel: "12034173023",
      email: "hello@reddingbmchandymanservices.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of Redding and nearby towns",
