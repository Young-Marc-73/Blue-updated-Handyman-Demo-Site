/* =========================================================
   Call Paul Handyman Services — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+14015291994" style="color:var(--color-science-blue);font-weight:600">(401) 529-1994</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Call Paul Handyman Services",
      phone: "(401) 529-1994",
      phoneTel: "14015291994",
      email: "hello@callpaulhandymanservices.com",
