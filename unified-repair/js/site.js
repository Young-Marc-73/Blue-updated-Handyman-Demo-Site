/* =========================================================
   Unified Home Repair — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12032236335" style="color:var(--color-science-blue);font-weight:600">(203) 223-6335</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Unified Home Repair",
      phone: "(203) 223-6335",
      phoneTel: "12032236335",
      email: "hello@unifiedhomerepair.com",
