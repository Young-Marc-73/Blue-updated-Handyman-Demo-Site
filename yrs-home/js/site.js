/* =========================================================
   Y.R.S. Home Improvement Contractors — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12033135036" style="color:var(--color-science-blue);font-weight:600">(203) 313-5036</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Y.R.S. Home Improvement Contractors",
      phone: "(203) 313-5036",
      phoneTel: "12033135036",
      email: "hello@yrshomeimprovementcontractors.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of Stamford and nearby towns",
