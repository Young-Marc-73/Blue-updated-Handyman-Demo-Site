/* =========================================================
   Milton Handyman Services — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12039427596" style="color:var(--color-science-blue);font-weight:600">(203) 942-7596</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Milton Handyman Services",
      phone: "(203) 942-7596",
      phoneTel: "12039427596",
      email: "hello@miltonhandymanservices.com",
