...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+16312355418" style="color:var(--color-science-blue);font-weight:600">(631) 235-5418</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Jay The Handyman",
      phone: "(631) 235-5418",
      phoneTel: "16312355418",
      email: "hello@jaythehandyman.com",
