/* =========================================================
   Triple J Handyman Service — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+16315597607" style="color:var(--color-science-blue);font-weight:600">(631) 559-7607</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Triple J Handyman Service",
      phone: "(631) 559-7607",
      phoneTel: "16315597607",
      email: "hello@triplejhandymanservice.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of Babylon and nearby towns",
