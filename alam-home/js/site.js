/* =========================================================
   Alam Home Improvement — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12677367408" style="color:var(--color-science-blue);font-weight:600">(267) 736-7408</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Alam Home Improvement",
      phone: "(267) 736-7408",
      phoneTel: "12677367408",
      email: "hello@alamhomeimprovement.com",
