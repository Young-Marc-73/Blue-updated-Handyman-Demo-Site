/* =========================================================
   203 Pro Home Improvement — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12035242373" style="color:var(--color-science-blue);font-weight:600">(203) 524-2373</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "203 Pro Home Improvement",
      phone: "(203) 524-2373",
      phoneTel: "12035242373",
      email: "hello@203prohomeimprovement.com",
      hours: "Mon\u2013Sat 7 AM \u2013 6 PM",
      emergency: "Yes \u2014 same-week service for most jobs, and we prioritize urgent issues",
      area: "all of Norwalk and nearby towns",
