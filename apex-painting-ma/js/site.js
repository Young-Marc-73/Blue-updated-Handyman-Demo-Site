/* =========================================================
   Apex Painting & Remodeling — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+15082154753" style="color:var(--color-science-blue);font-weight:600">(508) 215-4753</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Apex Painting & Remodeling",
      phone: "(508) 215-4753",
      phoneTel: "15082154753",
      email: "hello@apexpaintingremodeling.com",
