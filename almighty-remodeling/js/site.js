/* =========================================================
   Almighty Remodeling — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+15083956640" style="color:var(--color-science-blue);font-weight:600">(508) 395-6640</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Almighty Remodeling",
      phone: "(508) 395-6640",
      phoneTel: "15083956640",
      email: "hello@almightyremodeling.com",
