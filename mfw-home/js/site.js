/* =========================================================
   MFW Home Improvements — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+18574453765" style="color:var(--color-science-blue);font-weight:600">(857) 445-3765</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "MFW Home Improvements",
      phone: "(857) 445-3765",
      phoneTel: "18574453765",
      email: "hello@mfwhomeimprovements.com",
