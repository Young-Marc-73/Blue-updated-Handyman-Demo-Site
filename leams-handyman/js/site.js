/* =========================================================
   Leams Construction & Handyman — Site script
...
(function () {
    ...
    document.querySelectorAll(".lead-form form").forEach(function (form) {
      form.addEventListener("submit", function (e) {
        ...
        form.innerHTML =
          ...
          '<p style="margin-top:1rem;font-size:var(--text-regular)">Can\u2019t wait? Call <a href="tel:+12033992971" style="color:var(--color-science-blue);font-weight:600">(203) 399-2971</a></p>' +
          '</div>';
      });
    });
  }
  ...
  function initChatbot() {
    ...
    var BIZ = {
      name: "Leams Construction & Handyman",
      phone: "(203) 399-2971",
      phoneTel: "12033992971",
      email: "hello@leamsconstructionhandyman.com",
